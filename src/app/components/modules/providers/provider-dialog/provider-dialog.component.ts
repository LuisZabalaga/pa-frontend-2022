...
export class ProviderDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.providerForm = this.formBuilder.group({
      ...
      prov_razon_social: ['', Validators.required],
      prov_ruc: ['', Validators.required],
      prov_email: ['', Validators.required],
      prov_celular: ['', Validators.required],
      prov_direccion: ['', Validators.required],
